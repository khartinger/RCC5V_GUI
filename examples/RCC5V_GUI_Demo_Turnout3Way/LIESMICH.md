...
<h1>RCC5V_GUI_Demo_Turnout3Way: Dreiweg-Weichensymbole für die RCC5V-GUI</h1>
<a href="README.md">==> English version</a>&nbsp; &nbsp; &nbsp; 
</td></tr></table>   

# Einleitung
## Voraussetzung
Diese VUE-Anwendung zeigt, welche Symbole es zum Zeichnen von Dreiwegweichen gibt und wie diese angewendet werden. Da die Steuerung über MQTT-Befehle erfolgt, ist folgende Hardware erforderlich:   
* (Mindestens) eine Dreiwegweiche mit Ansteuerung über einen RCC-Mikrocontroller und RCC-Block
...
## Verfügbare Symbole
![Weichensymbole](./images/300_symbol_turnout3way1.png "Weichensymbole")   
