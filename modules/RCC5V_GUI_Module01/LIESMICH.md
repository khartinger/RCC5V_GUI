...
<h1>RCC5V_GUI_Module01_Uncoupler: Entkupplergleissymbole für die RCC5V-GUI</h1>
...
* (Mindestens) ein Entkuppler mit Ansteuerung über einen RCC-Mikrocontroller und RCC-Block
  Beispiel: Verwendung des RCC-Module 01s, der auf [https://github.com/khartinger/RCC5V/tree/main/examples/blocktester](https://github.com/khartinger/RCC5V/tree/main/examples/blocktester) beschrieben wird   
...
Visual Studio Code (VSC) starten, Projekt `RCC5V_GUI_Module01_Turnout` laden, Terminalfenster `npm run serve` eingeben
PC mit WLAN verbinden (zB `Raspi11`)


MQTT Server starten,
Voraussetzungen: IP `10.1.1.1`, Basis-Topic `rcc/module01`
1. Terminalfenster: `mosquitto_sub -h 10.1.1.1 -t rcc/# -v`   
2. Terminalfenster: `mosquitto_pub -h 10.1.1.1 -t rcc/module01/get -m bydcc`   
