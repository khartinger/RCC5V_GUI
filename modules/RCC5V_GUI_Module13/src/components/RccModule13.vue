...
<script setup lang="ts" name="RccModule13">
  ...
  const symbols = [
    // ..row 0..................................................
    { type: 'tk', row: 0, col: 0, sid: 'm13a1', dir: '0' },
    { type: 'tk', row: 0, col: 1, sid: 'm13b1', dir: '48' },
    { type: 'tk', row: 0, col: 2, sid: 'm13c1', dir: '0' },
    // ..row 1..................................................
    { type: 'tk', row: 1, col: 0, sid: 'tk133', dir: '15', h: '[ON]', ha: 'C', f: '133', fa: 'C' },
    { type: 'uc', row: 1, col: 1, sid: 'uc134', dir: '15', h: '[ON]', ha: 'C', f: '134', fa: 'C' },
    { type: 'tt', row: 1, col: 2, sid: 'tt132', dir: '5', h: '132', ha: 'R', f: '131', fa: 'R' },
    // ..row 2..................................................
    { type: 'tk', row: 2, col: 0, sid: 'm13a3', dir: '0' },
    { type: 'tk', row: 2, col: 1, sid: 'm13b3', dir: '26' },
    { type: 'tk', row: 2, col: 2, sid: 'm13c3', dir: '0' },
    // ..special symbols (connector, isolator)..................
    { type: 'tc', row: 0.5, col: 1.5, sid: 'con0', dir: '8' },
    { type: 'tc', row: 1.5, col: 1.5, sid: 'con0', dir: '2' },
    { type: 'ti', row: 1.0, col: 1.5, sid: 'iso0', dir: '1' },
   ]
  ...
  watchEffect(() => {
    if(rccMqttClientInstance.mqttState.connected) {
      rccMqttClientInstance.publish('rcc/module13/get', 'status', false, 0).catch((e) => { console.error('RccModule13: ERROR:', e) })
    }
  })
