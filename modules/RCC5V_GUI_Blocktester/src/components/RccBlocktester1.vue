...
<template>
  ...
  <RccUncoupler1   :x="x0+0*dx" :y="y0+1*dy" sid="uc1" dir="15" :border="border"></RccUncoupler1>
  <RccTrack1       :x="x0+1*dx" :y="y0+1*dy" sid="tk0" dir="15" :border="border"></RccTrack1>
  <RccTurnout3Way1 :x="x0+2*dx" :y="y0+1*dy" sid="t3w1" dir="4" :border="border"></RccTurnout3Way1>
  
  <RccTrack1    :x="x0+0*dx" :y="y0+2*dy" sid="tk0" dir="15" :border="1"></RccTrack1>
  <RccTurnout1  :x="x0+1*dx" :y="y0+2*dy" sid="to1" type="1L" :border="1"></RccTurnout1>  
  <RccTrack1    :x="x0+2*dx" :y="y0+2*dy" sid="tk1" dir="15" :border="1"></RccTrack1>
