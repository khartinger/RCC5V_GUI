...
<script setup lang="ts" name="RccModule12">
  ...
  const symbols = [
    // ..row 0..................................................
    { type: 'tk', row: 0, col: 0, sid: 'tk129', dir: '1',  f: ' 129  [OFF]', fa: 'L' },
    { type: 'to', row: 0, col: 1, sid: 'to123', dir: '5L', h: '123', ha: 'C' },
    { type: 'tk', row: 0, col: 2, sid: 'tk125', dir: '58', h: '125  [ON]', ha: 'R', f: '[OFF]' },
    { type: 'tk', row: 0, col: 3, sid: 'm12d1', dir: '0' },
    // ..row 1..................................................
    { type: 'tt', row: 1, col: 0, sid: 'tt121', dir: '1',  h: '121', ha: 'L', f: '122', fa: 'L' },
    { type: 'tk', row: 1, col: 1, sid: 'tk126', dir: '15', h: '126', ha: 'C', f: '[OFF]', fa: 'C' },
    { type: 'tk', row: 1, col: 2, sid: 'tk126', dir: '15', h: '126', ha: 'C', f: '[OFF]', fa: 'C' },
    { type: 'to', row: 1, col: 3, sid: 'to128', dir: '5R', h: '  128', ha: 'C' },
    // ..row 2..................................................
    { type: 'tk', row: 2, col: 0, sid: 'm12a3', dir: '0' },
    { type: 'tk', row: 2, col: 1, sid: 'tk127', dir: '14', h: '[ON]', ha: 'R', f: '127    [OFF]', fa: 'R' },
    { type: 'uc', row: 2, col: 2, sid: 'uc124', dir: '15', h: 'Uncoupler [ON]', ha: 'C', f: '124', fa: 'C' },
    { type: 'tk', row: 2, col: 3, sid: 'tk127', dir: '5', h: '[ON]', ha: '127  [OFF]', f: '[OFF]', fa: 'L' },
    // ..special symbols (connector, isolator)..................
    { type: 'ti', row: 0.0, col: 0.5, sid: 'iso0', dir: '1' },
    { type: 'ti', row: 0.5, col: 0.5, sid: 'iso0', dir: '2' },
    { type: 'ti', row: 0.5, col: 2.5, sid: 'iso0', dir: '4' },
    { type: 'ti', row: 1.0, col: 0.5, sid: 'iso0', dir: '1' },
    { type: 'ti', row: 1.0, col: 2.5, sid: 'iso0', dir: '1' },
    { type: 'ti', row: 1.5, col: 0.5, sid: 'iso0', dir: '4' },
  ]
  ...
  watchEffect(() => {
    if(rccMqttClientInstance.mqttState.connected) {
      rccMqttClientInstance.publish('rcc/module12/get', 'status', false, 0).catch((e) => { console.error('RccModule12: ERROR:', e) })
    }
  })
