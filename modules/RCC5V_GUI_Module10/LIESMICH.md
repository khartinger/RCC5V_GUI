...
<h1>RCC5V_GUI_Module10_Uncoupler: Entkupplergleissymbole für die RCC5V-GUI</h1>
...
* (Mindestens) ein Entkuppler mit Ansteuerung über einen RCC-Mikrocontroller und RCC-Block
  Beispiel: Verwendung des RCC-Module 10s, der auf [https://github.com/khartinger/RCC5V/tree/main/examples/blocktester](https://github.com/khartinger/RCC5V/tree/main/examples/blocktester) beschrieben wird   
...
Visual Studio Code (VSC) starten, Projekt `RCC5V_GUI_Module10_Turnout` laden, Terminalfenster `npm run serve` eingeben
PC mit WLAN verbinden (zB `Raspi11`)


MQTT Server starten,
Voraussetzungen: IP `10.1.1.1`, Basis-Topic `rcc/module10`
