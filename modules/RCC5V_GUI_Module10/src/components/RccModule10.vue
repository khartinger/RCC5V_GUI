...
<script setup lang="ts" name="RccModule10">
  ...
  const symbols = [
    // ..row 0..................................................
    { type: 'tk', row: 0, col: 0, sid: 'm10a1', dir: '0' },
    { type: 'tk', row: 0, col: 1, sid: 'm10b1', dir: '26' },
    { type: 'tk', row: 0, col: 2, sid: 'tk106', dir: '1', h: '106', ha: 'C' },
    { type: 'to', row: 0, col: 3, sid: 'to105', dir: '5L', h: '105', ha: 'C' },
    { type: 'uc', row: 0, col: 4, sid: 'uc108', dir: '15', h: '[ON]', ha: 'C', f: '108', fa: 'C' },
    // ..row 1..................................................
    { type: 'tt', row: 1, col: 0, sid: 'tt101', dir: '1',  h: '101', ha: 'C', f: '102', fa: 'C' },
    { type: 'tk', row: 1, col: 1, sid: 'tk106', dir: '15', f: '106', fa: 'C' },
    { type: 'tt', row: 1, col: 2, sid: 'tt103', dir: '1',  h: '103', ha: 'C', f: '104', fa: 'C' },
    { type: 'tk', row: 1, col: 3, sid: 'tk106', dir: '15', f: '106', fa: 'C' },
    { type: 'tk', row: 1, col: 4, sid: 'tk106', dir: '15', f: '106', fa: 'C' },
    // ..row 2..................................................
    { type: 'tk', row: 2, col: 0, sid: 'm10a3', dir: '0' },
    { type: 'tk', row: 2, col: 1, sid: 'm10b3', dir: '48' },
    { type: 'tk', row: 2, col: 2, sid: 'm10c3', dir: '0' },
    { type: 'tk', row: 2, col: 3, sid: 'tk107', dir: '48', f: '107', fa: 'C' },
    // ..special symbols (connector, isolator)..................
    { type: 'tc', row: 0.5, col: 0.5, sid: 'con0', dir: '2' },
    { type: 'tc', row: 0.5, col: 2.5, sid: 'con0', dir: '2' },
    { type: 'tc', row: 1.5, col: 0.5, sid: 'con0', dir: '4' },
    { type: 'ti', row: 1.0, col: 0.5, sid: 'iso0', dir: '1' },
    { type: 'ti', row: 1.5, col: 2.5, sid: 'iso0', dir: '4' },
   ]
  ...
  watchEffect(() => {
    if(rccMqttClientInstance.mqttState.connected) {
      rccMqttClientInstance.publish('rcc/module10/get', 'status', false, 0).catch((e) => { console.error('RccModule10: ERROR:', e) })
    }
  })
