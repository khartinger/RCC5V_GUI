...
<template>
  ...
  <text class="ciFont1" :x="x0-0.48*dx" :y="y0-0.3*dy">Module 14</text>
</g>
</template>
...
watchEffect(() => {
  if(ciMqttClientInstance.mqttState.connected) {
    ciMqttClientInstance.publish('rcc/demo1/get', 'status', false, 0).catch((e) => { console.error('RccModule14: ERROR:', e) })
  }
})
